...
const { VITE_HOST_SERVER_BASE_URL } = import.meta.env;
            ...
            <div className="relative h-[100vh]">
                ...
                <div className="absolute top-[80%] left-1/2 -translate-y-1/2 -translate-x-1/2 z-20 flex flex-col space-y-4 ">
                    ...
                    <img
                        ...
                        alt="카카오 로고 버튼"
                        onClick={() =>
                            (window.location.href = `${VITE_HOST_SERVER_BASE_URL}/api/oauth2/authorization/kakao?redirect_uri=/main&mode=login`)
                        }
                    />
